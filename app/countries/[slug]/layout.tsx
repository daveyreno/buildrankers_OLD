...
import RegionsSidebar from '@/app/components/sidebar/Regions';
import CitiesSidebar from '@/app/components/sidebar/Cities';
import Rank from '@/app/components/sidebar/Rank';
import createClient from '@/lib/supabase-server';
import CountryInfo from '@/app/components/sidebar/CountryInfo';
            ...
            <div className='flex items-center justify-center h-40 border-b md:h-48 lg:h-60'>
                <div className='flex flex-row justify-center w-full max-w-5xl p-4 lg:p-0'>
                    <div className='flex flex-col justify-center md:w-2/3'>
                        <h1 className='flex justify-center text-4xl font-extrabold tracking-tighter md:text-5xl'>{countryData.name}</h1>
                        <p className='flex justify-center md:mt-2 md:text-lg text-slate-500'>{countryData.continent}</p>
                    </div>
                ...
                <div className='w-full max-w-5xl p-4'>
                    <div className='flex flex-col gap-6 md:flex-row'>
                        ...
                        <div className='flex flex-col w-full gap-4 md:-mt-48 md:w-1/3'>
                            ...
                            <RegionsSidebar countryId={countryData.id} />
                            <CitiesSidebar countryId={countryData.id} />
                        </div>
                    </div>
                </div>
            </div>
